...
<?php
	...
	$miesiac1=date('m');
	$dzien1=date('d');
	echo "$rok-$miesiac1-$dzien1";
	

?>
<script>
var obecnyRok = <?php echo $rok; ?>;
var obecnyMiesiac =<?php echo $miesiac1; ?>;
var obecnyDzien =<?php echo $dzien1; ?>;
</script>
<head>
	<meta charset="utf-8" >
	<title>Tytan96</title>
...
<body onload="kalendarz()">
	...
	<button onclick="miesiac1()">Widok miesiaca </button>
	<button onclick="tydzien()">Widok tygodnia </button>
	<button onclick="dzien1()">Widok dnia </button>
	<div id="kalendarz">
	
			<button onclick="cofnij()" >&lt;</button><div id="name"> </div><button onclick="dalej()">&gt;</button>
